...
import { dropdownOptions, dropdownOptionsGrouped } from 'UIElement/DropdownOptions';
    ...
    <div>
      <div className="header">
        ...
        <div className="test">
          ...
          <div><DropdownUI id={"center"} options={dropdownOptionsGrouped(allRect)} onChange={setGroupedOptionHandler} value={groupedOption} /></div>
        </div>
        <div className="test">
          <label>Metric:</label>
